...
export const MOCK_WEEK_EVENTS: ScheduleEvent[] = [
  ...
  // ── Friday — "today" ──
  { id: 'fri-phil', dayKey: 'fri', courseCode: 'PHIL 232', title: 'Philosophy of Mind', startMinutes: hm(8, 45), endMinutes: hm(10), room: 'H-407', professor: 'Dr. O. Fenn', mode: 'P', tint: '#B8A090' },
  { id: 'fri-hist', dayKey: 'fri', courseCode: 'HIST 287', title: 'History of Quebec since 1867', startMinutes: hm(10, 15), endMinutes: hm(11, 30), room: 'H-302', professor: 'Dr. A. Moreau', mode: 'P', tint: '#C9B0A0' },
  { id: 'fri-engl', dayKey: 'fri', courseCode: 'ENGL 369', title: 'Modernism in English Literature', startMinutes: hm(13, 15), endMinutes: hm(15, 30), room: 'LB-625', professor: 'Prof. I. Ashwell', mode: 'B', tint: BRAND },
